...
export class initialMigration1661535809074 implements MigrationInterface {
    name = 'initialMigration1661535809074'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Comments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdOn" date NOT NULL, "description" character varying NOT NULL, "user_id" uuid, "ad_id" uuid, CONSTRAINT "REL_22ec3485cde8dfcd915922addc" UNIQUE ("user_id"), CONSTRAINT "PK_91e576c94d7d4f888c471fb43de" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "Comments" ADD CONSTRAINT "FK_c3b47144173204a52104afb705b" FOREIGN KEY ("ad_id") REFERENCES "Ads"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }
