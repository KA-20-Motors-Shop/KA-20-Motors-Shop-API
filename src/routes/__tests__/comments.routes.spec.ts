...
import adCreateService from "../../services/Ads/ad.create.service";
...
describe("Create, read ads", () => {
  ...
  test("Should insert new ad information ", async () => {
    ...
    const ad = await request(app).post("/ads").send(adData);
  ...
  test("Should be able to return a list of comments", async () => {
